...
var passwordValidityChecks = [
	{
		isInvalid: function(input) {
			return newpassword.value.length < 8 | newpassword.value.length > 100;
		},
	...
	{
		isInvalid: function(input) {
			return !newpassword.value.match(/[0-9]/g);
		},
	...
	{
		isInvalid: function(input) {
			return !newpassword.value.match(/[a-z]/g);
		},
	...
	{
		isInvalid: function(input) {
			return !newpassword.value.match(/[\!\@\#\$\%\^\&\*]/g);
		},
...
var passwordRepeatValidityChecks = [
	{
		isInvalid: function(input) {
			return document.getElementById('cfmnewpassword').value != document.getElementById('newpassword').value;
		},
...
var passwordRepeatInput = document.getElementById('cfmnewpassword');
